...
int scan_F(unsigned char Resolution,unsigned char ScanHead) {  //channel 5 data
...
int scan_L(unsigned char Resolution,unsigned char ScanHead) {  //channel 4 data
   PTM |= Resolution;   //Friendly
   PTP = ScanHead;      //Scanner direction (0 = tank heading)
  //Sample ADC4
...
int scan_R(unsigned char Resolution,unsigned char ScanHead) {  //channel 6 data
  PTM |= Resolution;   //Friendly
  PTP = ScanHead;      //Scanner direction (0 = tank heading)
  //Sample ADC56
